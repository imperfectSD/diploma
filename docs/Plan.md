...
9. Появляется сообщение об успешной операции.
...
8. Нажать кнопку "Продолжить";
9. Появляется сообщение об отказе в операции.
...
5. Кнопка "Продолжить" неактивна, под каждым полем сообщение об ошибке.
...
4. Под полем с невалидными данными сообщение об ошибке.
